...
public class LambdaAssignment3 {
	...
	public static void main(String[] args) {
		...
		String[] str = {"Anil", "Singh","Yogendra"};
		...
		Predicate<String[]> predicate = (string) -> Arrays.toString(string).contains("Singh");     //The Predicate interface has only one single method test().
